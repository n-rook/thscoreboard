...
class ReanalyzeReplayTest(test_case.ReplayTestCase):
    ...
    def testTimestampDiff(self):
        ...
        diff = reanalyze_replay.CheckReplay(replay.id)
        self.assertIn("2018-02-19T10:44:21+00:00 -> 2018-02-19T09:44:21+00:00", diff)
    ...
    def testStage2Diff(self):
        ...
        self.assertIn("[piv] 259660 -> 159660", diff)
    ...
    def testStage2Missing(self):
        ...
        diff = reanalyze_replay.CheckReplay(replay.id)
        self.assertIn("Stage 2:", diff)
        self.assertIn("[piv] (No model!) -> 159660", diff)
    ...
    def testStage2Missing_Update(self):
        ...
        old_stages = list(
            models.ReplayStage.objects.filter(replay=replay).order_by("stage")
        )
        stage2 = old_stages[1]
    ...
    def testReanalyzeFixesShot(self):
        ...
        replay.shot = models.Shot.objects.get(
            game=game_ids.GameIDs.TH07, shot_id="MarisaA"
        )
        replay.save()
    ...
    def testReanalyzeFixesRoute(self):
        ...
        replay.route = models.Route.objects.get(
            game=game_ids.GameIDs.TH08, route_id="Final A"
        )
        replay.save()
