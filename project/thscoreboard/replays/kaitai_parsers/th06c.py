...
class Th06c(KaitaiStruct):
    def __init__(self, _io, _parent=None, _root=None):
        super(Th06c, self).__init__(_io)
        self._parent = _parent
        self._root = _root or self
        self._read()

    def _read(self):
        self.file_header = Th06c.FileHeader(self._io, self, self._root)
    ...
    class FileHeader(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Th06c.FileHeader, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _read(self):
            ...
            self.stage_offsets = []
            for i in range(7):
                self.stage_offsets.append(Th06c.StagePointer(self._io, self, self._root))
    ...
    class Stage(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Th06c.Stage, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class StagePointer(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Th06c.StagePointer, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def body(self):
            ...
            if self.raw_offset != 0:
                ...
                self._m_body = Th06c.Stage(self._io, self, self._root)
                self._io.seek(_pos)
