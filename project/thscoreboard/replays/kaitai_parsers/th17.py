...
class Th17(KaitaiStruct):
    ...
    class Header(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Th17.Header, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
    ...
    class Stage(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Th17.Stage, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
        ...
        def _fetch_instances(self):
            ...
            for i in range(len(self.unknown_7)):
                pass

            self.unknown_timer._fetch_instances()
            self.hyper_time._fetch_instances()
            for i in range(len(self.unknown_8)):
                pass
    ...
    class Timer(KaitaiStruct):
        def __init__(self, _io, _parent=None, _root=None):
            super(Th17.Timer, self).__init__(_io)
            self._parent = _parent
            self._root = _root
            self._read()
