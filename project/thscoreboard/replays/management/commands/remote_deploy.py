...
class Command(base.BaseCommand):
    ...
    def add_arguments(self, parser: base.CommandParser) -> None:
        ...
        parser.add_argument(
            "target",
            help="The host (and port) of the server which should fetch a new version from HEAD.",
        )
        parser.add_argument(
            "username", help="The username of the superuser with deployment rights."
        )
        parser.add_argument(
            "password",
            nargs="?",
            help="The password of the superuser with deployment rights.",
        )
